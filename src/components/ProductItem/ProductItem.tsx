  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
        {data?.slice(0, 20).map((item: IProduct) => (
          <div
            key={item.id}
            className="group relative bg-white border rounded-lg overflow-hidden transition hover:shadow-md"
          >
            ...
            <div className="absolute inset-0 flex items-end justify-end px-2 pb-2 opacity-0 group-hover:opacity-100 transition">
              <button className="bg-black rounded-full p-1 shadow hover:bg-gray-800">
